package com.FaizDev.FaizNR.myflexiblefragment
 ...
 */
class OptionDialogFragment() : DialogFragment(), View.OnClickListener, Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<OptionDialogFragment> {
        override fun createFromParcel(parcel: Parcel): OptionDialogFragment {
            return OptionDialogFragment(parcel)
        }

        override fun newArray(size: Int): Array<OptionDialogFragment?> {
